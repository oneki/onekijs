      ...
      <div className="flex items-center justify-center h-screen flex-col">
        ...
        <div className="flex items-stretch bg-gray-100 rounded-lg">
          <div className="text-white p-10">
            ...
            <p className="text-base text-gray-500 mt-4">Basic username / password login</p>
            <div className="mt-6">
              <div className="max-w-4xl mx-auto">
                <label className="block">
                  <span className="block font-medium text-sm text-gray-900 leading-tight">Username</span>
                  <div className="mt-2">
                    <input
                      name="username"
                ...
                <label className="block mt-5">
                  <span className="block font-medium text-sm text-gray-900 leading-tight">Password</span>
                  <div className="mt-2">
                    <input
                      name="password"
                      type="password"
          ...
          <div className="content-center border-l-2 border-gray-200 pt-24 p-5">
            <IdpLoginButton name="Google" href="/login/google" className="bg-white" Icon={FcGoogle} />
            <IdpLoginButton name="Cognito" href="/login/cognito" className="bg-orange-200" Icon={FaAmazon} />
            <IdpLoginButton name="Itsme" href="/login/itsme" style={{ backgroundColor: '#e3e8e1' }} Icon={ItsmeIcon} />
          </div>
        </div>
      </div>
    </form>
...
const IdpLoginButton = ({ Icon, name, href = '', className = '', style = {} }) => {
  const cls =
