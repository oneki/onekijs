...
const AdminPage = () => {
  return (
    <div>
      This is the (protected) admin page. Only logged-in users with the role <b>ADMIN</b> can view it
    </div>
  );
};
...
const validator = (securityContext) => {
  return securityContext && securityContext.roles && securityContext.roles.includes('ADMIN');
};
...
const ErrorComponent = ({ error }) => {
  ...
  return <div className="text-red-500">You are not authorized to view this page</div>;
};
