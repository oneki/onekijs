import { Wizard, Step, ComponentStyle } from 'onekijs-ui';
...
const Page: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <Wizard title="New Virtual Machine" layout="vertical">
      <Step title="1. Services" key="test">
      ...
      <Step title="2. Resources" key="test1">
        <div>Section2</div>
      </Step>
      <Step title="3. Context" disabled={true} key="test2">
        <div>Section3</div>
      </Step>
    </Wizard>
  );
