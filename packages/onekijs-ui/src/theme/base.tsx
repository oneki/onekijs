...
export const baseTheme = (customTheme: Partial<Theme> = {}): Theme => {
  const theme: Partial<Theme> = {
    ...
    wizard: {
      ...
      hoverBorderWidth: 'inherit',
      hoverFontColor: 'inherit',
      marginBefore: 0,
      marginAfter: 0,
      modalStepsBgColor: 'lighter',
      modalStepsBorderColor: 'light',
      modalStepsBorderStyle: 'solid',
      modalStepsBorderWidth: '1px',
      paddingRight: 'lg',
      paddingLeft: 'lg',
      paddingTop: 'sm',
      paddingBottom: 'sm',
      stepsBgColor: 'none',
      stepsBorderColor: 'blue-200',
