...
import { borderBottomColor, borderColor, borderLeftColor, borderRadius, borderRightColor, borderStyle, borderTopColor, borderWidth, boxShadow } from '../../styles/border';
