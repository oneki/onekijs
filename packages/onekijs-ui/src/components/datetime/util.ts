...
export const defaultQuickRanges = (): AnonymousObject<DateQuickRange> => {
  return (['Last hour', 'Last day', 'Last week', 'Last month', 'Last year'] as DefaultQuickRange[]).reduce(
    (accumulator, label) => {
...
export const findQuickRangeLabel = (
  quickRanges: AnonymousObject<DateStringRange> | undefined,
  dateRange: DateStringRange | string | null | undefined,
): string | undefined => {
