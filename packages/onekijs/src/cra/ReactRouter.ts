import { History, Location as ReactRouterLocation, LocationState, LocationListener } from 'history';
import produce from 'immer';
import AppRouter from '../lib/app/AppRouter';
import { toUrl, toLocation } from '../lib/core/utils/url';
import { Location } from '../lib/app/typings';
...
export class ReactRouter extends AppRouter {
   ...
   * }
   */
  listen(callback: (location: Location) => void): LocationListener {
