export const i18nEn = {
  common: {
    ...
    'Welcome {{lastname}} on my website. Current date = {{date}}':
      'Welcome {{ lastname}} website. Current date = {{date | locale}}',
    ...
    'plural::Hello <1><2>mister</2> {{firstname}} {{lastname}} <3>male</3></1> <4>address</4>':
      'Hello <1><2>gentlemen</2> {{firstname}} {{lastname}} <3>male</3></1> <4>address</4>',
...
export const i18nFr = {
  common: {
    ...
    hello: 'Bonjour <1><2>monsieur</2> {{lastname}} {{firstname}}  <3>masculin</3></1> <4>adresse</4>',
    'plural::hello': 'Bonjour <1><2>messieurs</2> {{lastname}} {{firstname}}  <3>masculin</3></1> <4>adresses</4>',
    'Hello <1><2>mister</2> {{firstname}} {{lastname}} <3>male</3></1> <4>address</4>':
      'Bonjour <1><2>monsieur</2> {{lastname}} {{firstname}}  <3>masculin</3></1> <4>adresse</4>',
    'plural::Hello <1><2>mister</2> {{firstname}} {{lastname}} <3>male</3></1> <4>address</4>':
      'Bonjour <1><2>messieurs</2> {{lastname}} {{firstname}}  <3>masculin</3></1> <4>adresse</4>',
    'Hello <1><2>mister</2> {{firstname}} {{lastname}} <3>male</3></1> <4>address</4> <5>Welcome</5>':
