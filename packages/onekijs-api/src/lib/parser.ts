...
export class ElementParser {
  ...
  protected handleCallSignature(element: SignatureReflection, specialType?: SpecialType) {
    ...
    if (parameters) {
      parameters.forEach((parameter) => {
        const newSpecialType = this.handleSpecialType(parameter as any, specialType);
  ...
  protected handleDeclarationReflectionChildren(children: DeclarationReflection[], specialType?: SpecialType) {
    children.forEach((child) => {
      const newSpecialType = this.handleSpecialType(child as any, specialType);
  ...
  protected handleSpecialType(element: Reflection, specialType?: SpecialType): SpecialType | undefined {
